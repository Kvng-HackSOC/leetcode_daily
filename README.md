...
| 51 | [Convert Sorted List to Binary Search Tree](https://leetcode.com/problems/convert-sorted-list-to-binary-search-tree/) | Medium | [Python](trees/convert-sorted-list-to-bst.py) | ✅ |
| 52 | [Flatten Binary Tree to Linked List](https://leetcode.com/problems/flatten-binary-tree-to-linked-list/) | Medium | [Python](trees/flatten-binary-tree.py) | ✅ |
